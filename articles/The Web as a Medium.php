...
<p>The web and the building blocks that it is formed of are very powerful and versatile media for creation. However, unlike traditional media used for creating, for example, a work of art, the web is composed of mostly nonphysical components. The primary physical component of the web is the Internet, the interconnected servers upon which it is stored and the computers which access it. The nonphysical web is the entire collection of data that is stored and accessed by users. As such, the web is constantly changing and expanding. The web is an inherently creative endeavor. Everything on the web has been created by users with a multitude of tools, from basic building blocks to complex special effects. 
<br>
<br>
